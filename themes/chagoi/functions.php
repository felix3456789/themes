...
define( 'CHAGOI_VERSION', '1.0.4' );

if ( ! function_exists( 'chagoi_setup' ) ) {
	add_action( 'after_setup_theme', 'chagoi_setup' );
	/**
	 * Sets up theme defaults and registers support for various WordPress features.
	 *
	 */
	function chagoi_setup() {
		// Make theme available for translation.
		load_theme_textdomain( 'chagoi' );
		...
		register_nav_menus( array(
			'primary' => __( 'Primary Menu', 'chagoi' ),
		) );

		/**
		 * Set the content width to something large
		 * We set a more accurate width in chagoi_smart_content_width()
		 */
...
define('CHAGOI_THEME_URL','https://wpkoi.com/chagoi-wpkoi-wordpress-theme/','chagoi');
define('CHAGOI_WPKOI_AUTHOR_URL','https://wpkoi.com/','chagoi');
define('CHAGOI_WPKOI_SOCIAL_URL','https://www.facebook.com/wpkoithemes/','chagoi');
define('CHAGOI_WORDPRESS_REVIEW','https://wordpress.org/support/theme/chagoi/reviews/?filter=5','chagoi');
define('CHAGOI_DOCUMENTATION','https://wpkoi.com/docs/','chagoi');