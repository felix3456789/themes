...
if ( ! function_exists( 'chagoi_archive_title' ) ) {
	add_action( 'chagoi_archive_title', 'chagoi_archive_title' );
	/**
	 * Build the archive title
	 *
	 */
	function chagoi_archive_title() { ?>
		<header class="page-header<?php if ( is_author() ) echo ' clearfix';?>">
			<?php
			/**
			 * chagoi_before_archive_title hook.
			 *
			 */
			do_action( 'chagoi_before_archive_title' );
			?>
			...
			<?php
			/**
			 * chagoi_after_archive_title hook.
			 *
			 */
			do_action( 'chagoi_after_archive_title' );
			...
			/**
			 * chagoi_after_archive_description hook.
			 *
			 */
			do_action( 'chagoi_after_archive_description' ); ?>
		</header><!-- .page-header -->
		<?php
	}
}

if ( ! function_exists( 'chagoi_filter_the_archive_title' ) ) {
	add_filter( 'get_the_archive_title', 'chagoi_filter_the_archive_title' );
	/**
	 ...
	 */
	function chagoi_filter_the_archive_title( $title ) {
		if ( is_category() ) {
