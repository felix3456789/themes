...
add_action( 'after_setup_theme', 'chagoi_setup_woocommerce' );
/**
 * Set up WooCommerce
 *
 */
function chagoi_setup_woocommerce() {
	...
	add_action( 'woocommerce_sidebar', 'chagoi_construct_sidebars' );
}

if ( ! function_exists( 'chagoi_woocommerce_start' ) ) {
	add_action( 'woocommerce_before_main_content', 'chagoi_woocommerce_start', 10 );
	/**
	 * Add WooCommerce starting wrappers
	 *
	 */
	function chagoi_woocommerce_start() { ?>
...
if ( ! function_exists( 'chagoi_woocommerce_end' ) ) {
	add_action( 'woocommerce_after_main_content', 'chagoi_woocommerce_end', 10 );
	/**
	 * Add WooCommerce ending wrappers
	 *
	 */
	function chagoi_woocommerce_end() { ?>
						</div><!-- .entry-content -->
						<?php
						/**
...
if ( ! function_exists( 'chagoi_woocommerce_css' ) ) {
	add_action( 'wp_enqueue_scripts', 'chagoi_woocommerce_css', 100 );
	/**
	 * Add WooCommerce CSS
	 *
	 */
	function chagoi_woocommerce_css() {
		if ( ! class_exists( 'WooCommerce' ) ) {
			return;
		}

		$mobile = apply_filters( 'chagoi_mobile_media_query', '(max-width:768px)' );
...
if ( ! function_exists( 'chagoi_bbpress_css' ) ) {
	add_action( 'wp_enqueue_scripts', 'chagoi_bbpress_css', 100 );
	/**
	 * Add bbPress CSS
	 *
	 */
	function chagoi_bbpress_css() {
...
if ( ! function_exists( 'chagoi_buddypress_css' ) ) {
	add_action( 'wp_enqueue_scripts', 'chagoi_buddypress_css', 100 );
	/**
	 * Add BuddyPress CSS
	 *
	 */
	function chagoi_buddypress_css() {
...
if ( ! function_exists( 'chagoi_beaver_builder_css' ) ) {
	add_action( 'wp_enqueue_scripts', 'chagoi_beaver_builder_css', 100 );
	/**
	 ...
	 *
	 */
	function chagoi_beaver_builder_css() {
