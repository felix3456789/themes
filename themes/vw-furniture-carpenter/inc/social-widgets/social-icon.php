...
class VW_Furniture_Carpenter_Social_Widget extends WP_Widget {
	function __construct() {
		...
		// Base ID of your widget
			...
			__('Social Icon', 'vw-furniture-carpenter'),
			// Widget description
	...
	public function widget( $args, $instance ) {
		...
		//echo __( 'Hello, World!', 'vw-furniture-carpenter' );
	...
	public function form( $instance ) {
		...
		?>	
			...
			<p>
			<label for="<?php echo esc_attr($this->get_field_id('google')); ?>"><?php esc_html_e('Google+:','vw-furniture-carpenter'); ?></label>
