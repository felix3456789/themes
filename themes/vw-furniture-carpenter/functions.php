...
function vw_furniture_carpenter_scripts() {
	...
	wp_enqueue_script( 'vw-furniture-carpenter-custom-scripts-jquery', get_template_directory_uri() . '/assets/js/custom.js', array('jquery') );
...
function vw_furniture_carpenter_ie_stylesheet(){
	wp_enqueue_style('vw-furniture-carpenter-ie', get_template_directory_uri().'/css/ie.css');
	wp_style_add_data( 'vw-furniture-carpenter-ie', 'conditional', 'IE' );
}
add_action('wp_enqueue_scripts','vw_furniture_carpenter_ie_stylesheet');
...
define('VW_FURNITURE_CARPENTER_CREDIT','https://www.vwthemes.com/themes/free-furniture-wordpress-theme/','vw-furniture-carpenter');
